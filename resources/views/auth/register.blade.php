    ...
    <section id="contact" class="relative w-full min-h-screen bg-black text-[#ffb703]">
        ...
        <div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
            ...
            <div class="w-full md:w-1/2 p-5 md:px-0 mx-5">
                <div class="bg-gray-900 border border-[#ffb703] w-full lg:w-1/2 h-full p-5 pt-8">
                    <h3 class="text-2xl font-semibold mb-5">
                        Our Social Media
                    </h3>
                    <!-- list -->
                    <div class="flex flex-col gap-3">
                        <a href="#" class="flex items-center hover:text-white hover:bg-[#ffb703] p-2">
                            <svg fill="currentColor" class="w-6 h-6 m-2" xmlns="http://www.w3.org/2000/svg"
            ...
            <!-- Contact Me -->
            <form method="POST" action="{{ route('register') }}" class="w-full md:w-1/2 border border-[#ffb703] p-6 bg-gray-900">
                @csrf
